...
# find "/home/cypri/OneDrive/Desktop" -type f -name '.terraform' -exec rm -f {} +
...
# find "/home/cypri/OneDrive/Desktop" -type f -name '.terraform.lock.hcl' -exec rm -f {} +
# find "/home/cypri/OneDrive/Desktop" -type f -name '.terraform.tfstate.lock.info' -exec rm -f {} +
